...
Use `mini-runbot init` to generate this file interactively or `mini-runbot init --defaults` to copy
the bundled example values. Neither variant overwrites an existing destination.
